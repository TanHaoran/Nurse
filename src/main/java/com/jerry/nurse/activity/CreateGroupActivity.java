...
public class CreateGroupActivity extends BaseActivity {
    ...
    private void updateView(boolean isUpdate) {
        ...
        mAdapter = new ContactAdapter(this, R.layout.item_contact, mBodyDatas);
                ...
                switch (layoutId) {
                    case R.layout.item_contact_header:
                        ...
                        recyclerView.setAdapter(
                                new CommonAdapter<Contact>(CreateGroupActivity.this, R.layout.meituan_item_header_item, contactHeaderBean.getCityList()) {
                                    @Override
                                    public void convert(ViewHolder holder, final Contact contact) {
                                        ...
                                        holder.getConvertView().setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                Intent intent = ContactDetailActivity.getIntent(CreateGroupActivity.this, "");
